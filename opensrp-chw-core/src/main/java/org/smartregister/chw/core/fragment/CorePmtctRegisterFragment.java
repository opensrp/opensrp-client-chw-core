...
public class CorePmtctRegisterFragment extends BasePmtctRegisterFragment {
    ...
    public void initializeAdapter(Set<org.smartregister.configurableviews.model.View> visibleColumns) {
        CorePmtctRegisterProvider pmtctRegisterProvider = new CorePmtctRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
    ...
    protected void initializePresenter() {
        ...
        presenter = new BasePmtctRegisterFragmentPresenter(this, new BasePmtctRegisterFragmentModel(), viewConfigurationIdentifier);
    }
