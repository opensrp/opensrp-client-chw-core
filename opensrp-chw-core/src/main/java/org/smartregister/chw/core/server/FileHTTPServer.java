package org.smartregister.chw.core.server;
...
/**
 * A minimal HTTP server that serves a fhir bundle json file
 */
public class FileHTTPServer {
    public static final int PORT = 8085;

    private byte[] fhirBundle;
    ...
    public FileHTTPServer(Context context, String jsonFilePath) throws IOException {
    ...
    private byte[] readFromAssets(Context context, String path) throws IOException {
