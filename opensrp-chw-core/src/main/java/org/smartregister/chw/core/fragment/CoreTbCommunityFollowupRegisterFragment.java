...
import org.smartregister.chw.core.provider.CoreTbCommunityFollowupProvider;
...
public abstract class CoreTbCommunityFollowupRegisterFragment extends BaseTbCommunityFollowupRegisterFragment {
    ...
    public void initializeAdapter(@Nullable Set<? extends org.smartregister.configurableviews.model.View> visibleColumns) {
        CoreTbCommunityFollowupProvider tbRegisterProvider = new CoreTbCommunityFollowupProvider(getActivity(), visibleColumns, registerActionHandler, paginationViewHandler);
    ...
    public void countExecute() {
        ...
        try {
            ...
            String query = "select count(*) from " + presenter().getMainTable() + " inner join " + CoreConstants.TABLE_NAME.FAMILY_MEMBER +
                    " on " + presenter().getMainTable() + "." + CoreConstants.ENTITY_ID + " = " +
