...
public abstract class CoreTbRegisterFragment extends BaseTbRegisterFragment {
    ...
    public void initializeAdapter(@Nullable Set<? extends org.smartregister.configurableviews.model.View> visibleColumns) {
        CoreTbProvider tbRegisterProvider = new CoreTbProvider(getActivity(), visibleColumns, registerActionHandler, paginationViewHandler);
