...
public class HIA2ReportsActivity extends BaseActivity {
    ...
    private static final List<String> readOnlyList = new ArrayList<>(Arrays.asList("EPNT", "BCG", "BCG_plus12m", "HepBnaissance", "VPO_0", "VPO_1", "VPO_1_plus12m", "VPO_2", "VPO_2_plus12m", "VPO_3", "VPO_3_plus12m", "VPI", "VPI_plus12m", "Penta_1", "Penta_1_plus12m", "Penta_2", "Penta_2_plus12m", "Penta_3", "Penta_3_plus12m", "Pneumo_1", "Pneumo_1_plus12m", "Pneumo_2", "Pneumo_2_plus12m", "Pneumo_3", "Pneumo_3_plus12m", "Rota_1", "Rota_1_plus12m", "Rota_2", "Rota_2_plus12m", "RR_1", "RR_1_plus12m", "RR_2", "RR_2_plus12m", "MenA", "MenA_plus12m", "FJaune", "FJaune_plus12m", "VitA", "VitA_plus12m", "ECV", "ECV_plus12m"));
    ...
    public void refresh() {
        Intent intent = new Intent(HIA2ReportsActivity.this, HIA2ReportsActivity.class);
            ...
            try {
                if (month != null) {
                    ...
                    if (tallies != null) {
                        ...
                        Log.d("Tallies", "tallies are f** null");
                    }
                }
            } catch (Exception e) {
                Log.e(TAG, Log.getStackTraceString(e));
