...
public class CoreHivProfileInteractor extends BaseHivProfileInteractor implements CoreHivProfileContract.Interactor {
    private Context context;

    public CoreHivProfileInteractor(Context context) {
    ...
    private String getMemberVisitType(String baseEntityId) {
        ...
        } else if (TbDao.isRegisteredForTb(baseEntityId)) {
    ...
    public Date getLastVisitDate(HivMemberObject memberObject) {
    ...
    protected Alert getAlerts(Context context, String baseEntityID) {
        try {
            List<BaseUpcomingService> baseUpcomingServices = new ArrayList<>(new CoreHivUpcomingServicesInteractor().getMemberServices(context, toMember(HivDao.getMember(baseEntityID))));
